...
use niancode\wechat\Pay\Lib\WxPayData;
use niancode\wechat\Pay\Lib\WxPayResults;
...
class WxPayApi extends Component
{
	...
	public static function unifiedOrder($inputObj, $timeOut = 6)
	{
		...
		$result = WxPayResults::Inits($response);
	...
	public static function notify($callback, &$msg)
	{
		...
		try {
			...
			$result = WxPayResults::Inits($xml);

			// debug
	        Yii::error("\n====================start pay_http_raw_post===================");
	        Yii::error($result);
	        Yii::error("\n====================end pay_http_raw_post===================");
